...
// that window (§5). This screen is only reachable in that band — under 24h
// rescheduling is disabled entirely (Don, 2026-07-27) and routes to
// reschedule-blocked instead. The 50% applies to the session cost.
export default function RescheduleWarn() {
  ...
  const charge = booking.priceUsd * 0.5;
