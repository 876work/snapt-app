...
export interface JobOffer {
  ...
  /** Client paid for rush: edits due within hours, and it pays extra. */
  rush?: boolean;
  id: string;
  title: string;
  occasion: Occasion;
...
export const JOB_OFFERS: JobOffer[] = [
  ...
  { id: 'j3', title: 'Wedding highlight edit', occasion: 'Wedding', payUsd: 108.8, when: 'Remote · deliver within 24h', loc: 'Remote edit', distanceKm: 0, type: 'remote' },
];
