-- Legal consolidation: 13 document types -> 4.
--
-- Run as one transaction. Nothing is deleted: every superseded row becomes
-- status='archived' and stays queryable, which is what the consent records
-- point at.
--
-- Generated 2026-08-13 from the live text of all 14 published rows. The policy
-- wording is carried verbatim; only structure, a working-draft header and the
-- disclosures listed in each ADDENDUM were added.

begin;


-- ---------- Terms of Service v2 ----------
insert into policy_documents (doc_type, version, title, content, status, published_at, requires_reconsent)
values ('terms', 2, 'Terms of Service', $legal$Snapt — Terms of Service
WORKING DRAFT — pending attorney review. Not yet legal advice.
Effective date: [Insert date]    Last consolidated: 2026-08-13
Contact: hello@snaptcarib.app

This document consolidates what were previously separate policies: Terms of Service (v1), Cancellation & Refund Policy (v1), Content & Usage Policy (v1), Dispute Resolution Policy (v1), Minor Safety & Age Policy (v1).
Each part below is reproduced from the policy named at its head, and KEEPS THAT
POLICY'S OWN SECTION NUMBERING. A reference to "Section 6" therefore means
Section 6 of the part it appears in.

The text below still refers to some of these policies by their former names, as
separate documents. Those references remain accurate: each now means the
correspondingly named Part of this document, or — where a policy was
consolidated elsewhere — the document that absorbed it. No policy position has
been altered by this consolidation.

────────────────────────────────────────────────────────────────
PART: TERMS OF SERVICE
(reproduced from: Terms of Service, version 1)
────────────────────────────────────────────────────────────────
...
12. Contact
Questions about these Terms: hello@snaptcarib.app

────────────────────────────────────────────────────────────────
PART: CANCELLATION & REFUND POLICY
(reproduced from: Cancellation & Refund Policy, version 1)
────────────────────────────────────────────────────────────────
...
9. Contact
Questions about a cancellation, reschedule, or refund: hello@snaptcarib.app

────────────────────────────────────────────────────────────────
PART: CONTENT & USAGE POLICY
(reproduced from: Content & Usage Policy, version 1)
────────────────────────────────────────────────────────────────
...
────────────────────────────────────────────────────────────────
PART: DISPUTE RESOLUTION POLICY
(reproduced from: Dispute Resolution Policy, version 1)
────────────────────────────────────────────────────────────────
...
Open or ask about a dispute: hello@snaptcarib.app

────────────────────────────────────────────────────────────────
PART: MINOR SAFETY & AGE POLICY
(reproduced from: Minor Safety & Age Policy, version 1)
────────────────────────────────────────────────────────────────
...
────────────────────────────────────────────────────────────────
ADDENDUM — DISCLOSURES ADDED AT CONSOLIDATION
────────────────────────────────────────────────────────────────

Currency. All charges are made in United States Dollars (USD). Prices shown in
East Caribbean Dollars (XCD) anywhere in the app are a display-only conversion
for your convenience, calculated at a rate Snapt sets and which is 2.72 XCD per
USD at the date above. Your bank or card issuer may apply its own conversion
rate and fees to the USD amount actually charged.
$legal$, 'published', now(), false);


-- ---------- Privacy Policy v2 ----------
insert into policy_documents (doc_type, version, title, content, status, published_at, requires_reconsent)
values ('privacy', 2, 'Privacy Policy', $legal$Snapt — Privacy Policy
WORKING DRAFT — pending attorney review. Not yet legal advice.
Effective date: [Insert date]    Last consolidated: 2026-08-13
Contact: hello@snaptcarib.app

This document consolidates what were previously separate policies: Privacy Policy (v1), Data Retention Policy (v2), Notification Policy (v1).
Each part below is reproduced from the policy named at its head, and KEEPS THAT
POLICY'S OWN SECTION NUMBERING. A reference to "Section 6" therefore means
Section 6 of the part it appears in.
...
────────────────────────────────────────────────────────────────
PART: PRIVACY POLICY
(reproduced from: Privacy Policy, version 1)
────────────────────────────────────────────────────────────────
...
11. Contact
Questions or requests about your data: hello@snaptcarib.app

────────────────────────────────────────────────────────────────
PART: DATA RETENTION POLICY
(reproduced from: Data Retention Policy, version 2)
────────────────────────────────────────────────────────────────
...
Questions or deletion requests: hello@snaptcarib.app

────────────────────────────────────────────────────────────────
PART: NOTIFICATION POLICY
(reproduced from: Notification Policy, version 1)
────────────────────────────────────────────────────────────────
...
features as they're built. No SMS channel exists in this product.

────────────────────────────────────────────────────────────────
ADDENDUM — DISCLOSURES ADDED AT CONSOLIDATION
────────────────────────────────────────────────────────────────

Processors. Snapt shares the minimum personal data necessary with the following
processors, each under contract and for the purpose stated:
  Stripe — payments and payouts
  Supabase — database, authentication and file storage
  Cloudflare R2 — storage of photos and video you upload or receive
  Didit — identity verification for creators
  Resend — transactional email
  Google Maps — maps, and placing your meeting point
  Firebase — delivery of push notifications
  Sentry — crash and error diagnostics from the app

Sentry, Google Maps and Firebase are named here for completeness; Sentry was
added to the app in August 2026. Snapt configures Sentry to exclude message
content, payout details and identity-verification data from what it collects.
$legal$, 'published', now(), false);


-- ---------- Creator Agreement v2 ----------
insert into policy_documents (doc_type, version, title, content, status, published_at, requires_reconsent)
values ('creator-agreement', 2, 'Creator Agreement', $legal$Snapt — Creator Agreement
WORKING DRAFT — pending attorney review. Not yet legal advice.
Effective date: [Insert date]    Last consolidated: 2026-08-13
Contact: hello@snaptcarib.app

This document consolidates what were previously separate policies: Creator Agreement (v1), Payment & Payout Policy (v1), Background Check & Vetting Disclosure (v1).
Each part below is reproduced from the policy named at its head, and KEEPS THAT
POLICY'S OWN SECTION NUMBERING. A reference to "Section 6" therefore means
Section 6 of the part it appears in.
...
The Background Check & Vetting Disclosure is the final part of this document and
is consented to separately during the creator application.

────────────────────────────────────────────────────────────────
PART: CREATOR AGREEMENT
(reproduced from: Creator Agreement, version 1)
────────────────────────────────────────────────────────────────
...
identity of acceptance are recorded by the platform.

────────────────────────────────────────────────────────────────
PART: PAYMENT & PAYOUT POLICY
(reproduced from: Payment & Payout Policy, version 1)
────────────────────────────────────────────────────────────────
...
Questions about a charge or payout: hello@snaptcarib.app

────────────────────────────────────────────────────────────────
PART: BACKGROUND CHECK & VETTING DISCLOSURE
(reproduced from: Background Check & Vetting Disclosure, version 1)
────────────────────────────────────────────────────────────────
...
application flow, with the date, time, and version of this document recorded.
$legal$, 'published', now(), true);


-- ---------- Trust & Safety Policy v3 ----------
insert into policy_documents (doc_type, version, title, content, status, published_at, requires_reconsent)
values ('trust-safety', 3, 'Trust & Safety Policy', $legal$Snapt — Trust & Safety Policy
WORKING DRAFT — pending attorney review. Not yet legal advice.
Effective date: [Insert date]    Last consolidated: 2026-08-13
Contact: hello@snaptcarib.app

This document consolidates what were previously separate policies: Trust & Safety Policy (v2), Accessibility Statement (v1).
Each part below is reproduced from the policy named at its head, and KEEPS THAT
POLICY'S OWN SECTION NUMBERING. A reference to "Section 6" therefore means
Section 6 of the part it appears in.
...
────────────────────────────────────────────────────────────────
PART: TRUST & SAFETY POLICY
(reproduced from: Trust & Safety Policy, version 2)
────────────────────────────────────────────────────────────────
...
Questions or reports: hello@snaptcarib.app

────────────────────────────────────────────────────────────────
PART: ACCESSIBILITY STATEMENT
(reproduced from: Accessibility Statement, version 1)
────────────────────────────────────────────────────────────────
...
Review
We review this statement, and our accessibility progress, at least [annually].
$legal$, 'published', now(), false);


-- Archive every superseded version, including trust-safety v1 and v2 (two
-- published rows of one doc_type was itself ambiguous) and the nine absorbed
-- document types. Archived, never deleted: consent_records reference these ids.
update policy_documents set status = 'archived'
where status = 'published'
  and (
    doc_type in ('cancellation', 'content-usage', 'dispute-resolution', 'minor-safety', 'data-retention', 'notifications', 'payment-payout', 'background-check', 'accessibility')
    or (doc_type = 'terms' and version < 2)
    or (doc_type = 'privacy' and version < 2)
    or (doc_type = 'creator-agreement' and version < 2)
    or (doc_type = 'trust-safety' and version < 3)
  );

-- Expect exactly 4 published rows, 14 archived.
select status, count(*) from policy_documents group by status order by status;
select doc_type, version, title, status from policy_documents
where status = 'published' order by doc_type;
